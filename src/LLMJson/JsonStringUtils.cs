...
public static class StringExtensions
{
    ...
    {
        return str.Substring(Math.Max(0,startIndex), Math.Min(length, str.Length - startIndex));
    }
    ...
    //    var startIndex = (str.Length >= 2 && (str[0] == '"' || str[0] == '\'')) ? 1 : 0;
    //    var length     = (str.Length >= 2 && (str[^1] == '"' || str[^1] == '\'')) ? str.Length -1- startIndex : str.Length - startIndex;

    //    return str.SubstringSafe(startIndex, length);
    //}
}
